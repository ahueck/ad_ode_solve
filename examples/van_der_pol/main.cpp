...
int main(int argc, char** argv) {
  ...
  options.add_options("Time")
      ("t0", "Start time", opt::value<realtype>()->default_value("0.0"))
      ("tN", "End time", opt::value<realtype>()->default_value("3000.0"))
      ("ts", "Time step", opt::value<realtype>()->default_value("10.0"));

  options.add_options("Tolerance")
      ("r,relative", "Relative tolerances", opt::value<realtype>()->default_value("1.1e-13"))
  ...
  options.add_options("Initial value")
      ("i,initial", "Initial value of ODE", opt::value<std::vector<realtype>>());
